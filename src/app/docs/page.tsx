...
export default function Docs() {
    return (
        <>
            <DefaultLayout>
                <h1 className="mb-8 text-5xl font-bold">Documentación</h1>
                <p>
                    ¡Bienvenidos a la web de la Delegación de Alumnos de
                    Industriales! En esta sección podrás encontrar información
                    sobre los servicios que ofrecemos, las formas de acceder a
                    ellos y mucho más.
                </p>
